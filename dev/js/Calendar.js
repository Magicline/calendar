(function (root, factory) {
	...
	Calendar.prototype.presetCreate = function() {
		...
		$('.dr-list-item', this.element).each(function() {
			...
			} else if (month_count == '14days') {
				first_day = moment(self.latest_date).subtract(14, 'day');
				last_day = moment(self.latest_date);
			} else {
	...
	function ranges() {
		return '<li class="dr-list-item" data-months="14days">' + i18n.l('datetime.last.14.days') + '&nbsp;<span class="dr-item-aside"></span></li>' +
			'<li class="dr-list-item" data-months="days">' + i18n.l('datetime.last.30.days') + '&nbsp;<span class="dr-item-aside"></span></li>' +
